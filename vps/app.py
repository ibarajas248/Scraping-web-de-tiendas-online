...
def vista_reporte():
    ...
    # ⛔ NUEVO: Solo ejecuta cuando hay EANs. Si no, muestra mensaje y corta.
    if not f["ean_list"]:
    ...
    if not kpis.empty:
        ...
        #c3.metric("Productos distintos", int(kpis.loc[0, "productos_distintos"]))

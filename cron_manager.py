...
st.title("⚙️ Panel visual de CronJobs (VPS)")
...
with st.sidebar:
    ...
    st.caption("Sugerencia: guarda estas credenciales en `st.secrets` o variables de entorno para mayor seguridad.")
...
log_choice = st.radio("Logs", ["Enviar a /dev/null", "Escribir a archivo", "Sin redirección"], horizontal=True)
log_path = ""
...
st.caption("💡 Tip: usa '*/15' para cada 15 minutos, '*' para cualquier valor, y 0–6 en día de semana (0=Dom).")

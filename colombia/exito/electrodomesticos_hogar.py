...
def main():
    ...
    with sync_playwright() as p:
        ...
        for page_num in range(1, args.max_pages + 1):
            listing_url = (
                f"{BASE}/electrodomesticos/electrodomesticos-hogar?"
                f"category-1=electrodomesticos&category-2=electrodomesticos-hogar&facets=category-1%2Ccategory-2&sort=score_desc&page={page_num}"
            )

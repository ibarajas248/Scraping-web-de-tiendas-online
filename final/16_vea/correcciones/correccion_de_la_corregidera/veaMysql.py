...
if __name__ == "__main__":
    ...
    try:
        ...
        for i, (_, r) in enumerate(df.iterrows(), start=1):
            ...
            # ==========================================================
            # ✅ NUEVO: si "IsAvailable": false -> NO insertar en la DB
            # (evita crear producto / producto_tienda / historico)
            # ==========================================================
            is_av = r.get("isAvailable")
            if (isinstance(is_av, (bool, np.bool_)) and (not bool(is_av))) or \
               (isinstance(is_av, str) and is_av.strip().lower() in ("false", "0", "no")):
                continue
            # ==========================================================

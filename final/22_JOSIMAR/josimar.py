...
# ---------------- Orquestador ----------------
def run_to_mysql(base: str, step: int, sales_channel: Optional[int]):
    ...
    if not all_rows:
        raise RuntimeError("No se obtuvieron filas; la tienda puede requerir otra configuración de sc.")

    print(f"💾 Preparando inserción MySQL ({len(all_rows)} filas)…")
